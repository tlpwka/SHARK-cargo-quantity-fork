...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '// define the newgrf\ngrf {\n//\tgrfid: "\\41\\4E\\02\\01";\n\tgrfid: "\\4A\\44\\BB\\B1";\n\tname: string(STR_GRF_NAME);\n\tdesc: string(STR_GRF_DESCRIPTION);\n\tversion: ${repo_vars.repo_version};\n\tmin_compatible_version: 1710;\n\tparam 0 {\n        param_reset_construction_costs {\n            type:    bool;\n            name:    string(STR_PARAM_RESET_CONSTRUCTION_COSTS);\n            desc:    string(STR_PARAM_RESET_CONSTRUCTION_COSTS_DESC);\n            bit: 0;\n            def_value: 1;\n        }\n    }\n\tparam 1 {\n        param_adjust_ship_speed {\n            type:    int;\n            name:    string(STR_PARAM_ADJUST_SHIP_SPEEDS);\n            min_value: 0;\n            max_value: 2;\n            def_value: 1;\n            names: {\n                0: string(STR_PARAM_ADJUST_SHIP_SPEEDS_OPTION_0);\n                1: string(STR_PARAM_ADJUST_SHIP_SPEEDS_OPTION_1);\n                2: string(STR_PARAM_ADJUST_SHIP_SPEEDS_OPTION_2);\n            };\n        }\n    }\n\tparam 2 {\n\t\tparam_roster {\n\t\t\tname: string(STR_PARAM_ROSTER);\n\t\t\tdesc: string(STR_PARAM_ROSTER_DESC);\n\t\t\tmin_value: 0;\n\t\t\tmax_value: ${len(registered_rosters)-1};\n\t\t\tnames: {\n\t\t\t    ' (1:0)> braces_required=True translation=False default='"?"' default_marker='"?"' at 7f2fb84e6a90> -> __content_139842944183280
            __token = 0
            __token = 154
            __content_139842944183280 = _lookup_attr(getitem('repo_vars'), 'repo_version')
            __content_139842944183280 = __quote(__content_139842944183280, '\x00', '&#0;', None, None)
            __token = 1080
            __content_139842944183280_1078 = (len(getitem('registered_rosters')) - 1)
            __content_139842944183280_1078 = __quote(__content_139842944183280_1078, '\x00', '&#0;', None, None)
            __content_139842944183280 = ('%s%s%s%s%s' % ('// define the newgrf\ngrf {\n//\tgrfid: "\\41\\4E\\02\\01";\n\tgrfid: "\\4A\\44\\BB\\B1";\n\tname: string(STR_GRF_NAME);\n\tdesc: string(STR_GRF_DESCRIPTION);\n\tversion: ', (__content_139842944183280 if (__content_139842944183280 is not None) else ''), ';\n\tmin_compatible_version: 1710;\n\tparam 0 {\n        param_reset_construction_costs {\n            type:    bool;\n            name:    string(STR_PARAM_RESET_CONSTRUCTION_COSTS);\n            desc:    string(STR_PARAM_RESET_CONSTRUCTION_COSTS_DESC);\n            bit: 0;\n            def_value: 1;\n        }\n    }\n\tparam 1 {\n        param_adjust_ship_speed {\n            type:    int;\n            name:    string(STR_PARAM_ADJUST_SHIP_SPEEDS);\n            min_value: 0;\n            max_value: 2;\n            def_value: 1;\n            names: {\n                0: string(STR_PARAM_ADJUST_SHIP_SPEEDS_OPTION_0);\n                1: string(STR_PARAM_ADJUST_SHIP_SPEEDS_OPTION_1);\n                2: string(STR_PARAM_ADJUST_SHIP_SPEEDS_OPTION_2);\n            };\n        }\n    }\n\tparam 2 {\n\t\tparam_roster {\n\t\t\tname: string(STR_PARAM_ROSTER);\n\t\t\tdesc: string(STR_PARAM_ROSTER_DESC);\n\t\t\tmin_value: 0;\n\t\t\tmax_value: ', (__content_139842944183280_1078 if (__content_139842944183280_1078 is not None) else ''), ';\n\t\t\tnames: {\n\t\t\t    ', ))
            ...
            # <Static value=<ast.Dict object at 0x7f2fb83dc3d0> name=None at 7f2fb8365f50> -> __attrs_139842931962832
            __attrs_139842931962832 = _static_139842931246032
            __backup_roster_139842945957952 = get('roster', __marker)

            # <Value 'registered_rosters' (39:35)> -> __iterator
            __token = 1155
            __iterator = getitem('registered_rosters')
            (__iterator, ____index_139842932338640, ) = getitem('repeat')('roster', __iterator)
            econtext['roster'] = None
            for __item in __iterator:
                econtext['roster'] = __item

                # <Interpolation value=<Substitution '\n                    ${roster.numeric_id - 1}: string(STR_PARAM_ROSTER_OPTION_${roster.numeric_id - 1});\n\t\t\t    ' (39:55)> braces_required=True translation=False default='"?"' default_marker='"?"' at 7f2fb8207a10> -> __content_139842944183280
                __token = 1196
                __token = 1198
                __content_139842944183280 = (_lookup_attr(getitem('roster'), 'numeric_id') - 1)
                __content_139842944183280 = __quote(__content_139842944183280, '\x00', '&#0;', None, None)
                __token = 1255
                __content_139842944183280_1253 = (_lookup_attr(getitem('roster'), 'numeric_id') - 1)
                __content_139842944183280_1253 = __quote(__content_139842944183280_1253, '\x00', '&#0;', None, None)
                __content_139842944183280 = ('%s%s%s%s%s' % ('\n                    ', (__content_139842944183280 if (__content_139842944183280 is not None) else ''), ': string(STR_PARAM_ROSTER_OPTION_', (__content_139842944183280_1253 if (__content_139842944183280_1253 is not None) else ''), ');\n\t\t\t    ', ))
                if (__content_139842944183280 is None):
                    pass
                else:
                    if (__content_139842944183280 is None):
                ...
                if (__content_139842944183280 is not None):
                    __append(__content_139842944183280)
                ____index_139842932338640 -= 1
                if (____index_139842932338640 > 0):
                    __append('')
            if (__backup_roster_139842945957952 is __marker):
                del econtext['roster']
            else:
                econtext['roster'] = __backup_roster_139842945957952

            # <Interpolation value=<Substitution '\n\t\t\t};\n\t\t}\n\t}\n}\n\n\nbasecost {\n \tPR_RUNNING_SHIP: 2;\n \tPR_BUILD_VEHICLE_SHIP: 2;\n}\n\nif (param_reset_construction_costs) {\n    basecost {\n \t    PR_BUILD_CANAL: -3;\n \t    PR_CLEAR_CANAL: -4;\n        PR_BUILD_AQUEDUCT: -2;\n        PR_CLEAR_AQUEDUCT: -4;\n        PR_BUILD_LOCK: -1;\n        PR_CLEAR_LOCK: -2;\n    }\n}\n\n// sort order\nsort(FEAT_SHIPS, ${[ship.numeric_id for ship in ships]});\n' (41:21)> braces_required=True translation=False default='"?"' default_marker='"?"' at 7f2fb848bdd0> -> __content_139842944183280
            __token = 1305
            __token = 1646
            __content_139842944183280 = [_lookup_attr(getitem('ship'), 'numeric_id') for econtext['ship'] in getitem('ships')]
            __content_139842944183280 = __quote(__content_139842944183280, '\x00', '&#0;', None, None)
            __content_139842944183280 = ('%s%s%s' % ('\n\t\t\t};\n\t\t}\n\t}\n}\n\n\nbasecost {\n \tPR_RUNNING_SHIP: 2;\n \tPR_BUILD_VEHICLE_SHIP: 2;\n}\n\nif (param_reset_construction_costs) {\n    basecost {\n \t    PR_BUILD_CANAL: -3;\n \t    PR_CLEAR_CANAL: -4;\n        PR_BUILD_AQUEDUCT: -2;\n        PR_CLEAR_AQUEDUCT: -4;\n        PR_BUILD_LOCK: -1;\n        PR_CLEAR_LOCK: -2;\n    }\n}\n\n// sort order\nsort(FEAT_SHIPS, ', (__content_139842944183280 if (__content_139842944183280 is not None) else ''), ');\n', ))
            if (__content_139842944183280 is None):
                pass
            else:
                if (__content_139842944183280 is None):
