...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '// -- begin ${ship.title} -- ' (1:0)> braces_required=True translation=False default='"?"' default_marker='"?"' at 7f2fb81c4650> -> __content_139842944183280
            __token = 0
            __token = 14
            __content_139842944183280 = _lookup_attr(getitem('ship'), 'title')
            __content_139842944183280 = __quote(__content_139842944183280, '\x00', '&#0;', None, None)
            __content_139842944183280 = ('%s%s%s' % ('// -- begin ', (__content_139842944183280 if (__content_139842944183280 is not None) else ''), ' -- ', ))
